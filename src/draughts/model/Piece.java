...
public class Piece {
     ...
     * @param type, the type of the piece, either MAN or KING. 
     */
    ...
    /**
     * Constructor for a piece, either MAN or KING. 
     * @param color, the color code for the piece. 
     * @param type, the type of the piece, either man or king. 
     * @param label, the label of the square where the piece is located. 
     */
