 ...
 *  
 *  event : the name of the tournament or match event. <p>
 *  
 *  site : the location of the event. <br>
 ...
 *  black : the player of the Black pieces, same format as White. <p>
 *  
 *  result : the result of the game. <br>
 *  Possible values, depending on the type of result format : 
 *  - DEFAULT : "1-0" (white won), "0-1" (black won), "1/2-1/2" (draw), or "*" (other, e.g., the game is ongoing). <br>
 *  - INTERNATIONAL : "2-0" (white won), "0-2" (black won), "1-1" (draw), "0-0" (lost for both players), "*" (other, e.g., the game is ongoing). <p>
 *  
 *  GameType : the type of the draughts game. <br>
 *  Possible values: <br>
 *  - INTERNATIONAL (20), <br>
 *  - ENGLISH (21), <br>
 *  - ITALIAN (22), <br>
 ...
 *  
 *  FEN : the initial position of the draughts board. <br>
 *  <b>See</b> the {@code FEN} class for more information. <p>
 *  
 *  moveText : moveText contains the actual moves for the game. <br>
...
public class PDN {
    ...
    /**
     * event : the name of the tournament or match event. <br>
     * <i>Default value = "?". </i>
     */
    public String event;
    /**
    ...
    public String site;
    /**
    * date : the starting date of the game, in YYYY.MM.DD form. <br>
    * "??" are used for unknown values. <br>
    * <i>Default value = "????.??.??". </i>
    */
    public String date;
    /**
     * round : the playing round ordinal of the game. <br>
     * <i>Default value = "?". </i>
     */
    public String round;
    /**
     * white : the player of the White pieces, in "last name, first name" format. <br>
     * <i>Default value = "?". </i>
     */
    public String white;
    /**
     * black : the player of the Black pieces, same format as White. <br>
     * <i>Default value = "?". </i>
     */
    public String black;
    /**
     ...
     *  - FRISIAN (40), <br>
     *  - SPANTSIRETTI (41). <br>
     *  <i>Default value = INTERNATIONAL (20). </i>
     */
    public GameType gameType;            
    /**
     * setup : present if a setup (FEN field) is indicated. <br>
     * <i>Default value = "". </i>
     */
    public String setup;
    /**
     * fen (optional) : the initial position on the checkers board. <br>
     ...
     *  Possible values, depending on the type of result format : 
     *  - DEFAULT : "1-0" (white won), "0-1" (black won), "1/2-1/2" (draw), or "*" (other, e.g., the game is ongoing). <br>
     *  - INTERNATIONAL : "2-0" (white won), "0-2" (black won), "1-1" (draw), "0-0" (lost for both players), "*" (other, e.g., the game is ongoing).
     */
     ...
     * 
     * @param gameType : the draughts game type. 
     * @param setDefaultValues : whether to use default values for or not. <br>
     * <i>Concerns pieces starting position and first player to move. </i>
     */
     ...
     * @param gameType : the type of the game. <br>
     * {@code pdnNotation} is the notation format to use for the labeling. It is composed of: <br>
     * - a character indicating the notation type: <br>
     * -  A = alpha/numeric like chess, <br>
     * -  N = numeric like draughts. <p>
     * - followed by a number indicating the location of the first square (A1 or 1) from the perspective of the starting player: <br>
     * -  0 = Bottom left <br>
     * -  1 = Bottom right <br>
     * -  2 = Top left <br>
     * -  3 = Top right <br>
     * 
     * @return String, the label of this square. 
     */
